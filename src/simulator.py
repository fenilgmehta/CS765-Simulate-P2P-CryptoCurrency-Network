...
class SimulatorParameters:
    ...
    def __init__(self) -> None:
        ...
        self.T_k_exp_sec_low: float = 420.0  # Point 7 of PDF: CPU power of the node is high
        self.T_k_exp_sec_high: float = 600.0  # Point 7 of PDF: CPU power of the node is low
    ...
    def load_from_file(self, config_file_name: str):
        ...
        self.T_k_exp_sec_low: float = parameters['T_k_exp_sec_low']
        self.T_k_exp_sec_high: float = parameters['T_k_exp_sec_high']
